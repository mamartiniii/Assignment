...
% method) to find the optimal values of alphas to use for under-relaxation.
% It returns err = err_pressure + err_velocity which is the quantity we
% would like to minimize



alpha_u = alpha_vect(1);
alpha_p = alpha_vect(2);
